...
namespace Checkbook_Organizer__BASIC
{
    public partial class CheckbookOrganizer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connect.ConnectionString = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source= C:\Users\RiyazKhan\Desktop\POS 409\CheckBook Organizer- Database\Checkbook.mdb";

            OleDbCommand command = new OleDbCommand();
            command.Connection = connect;
            command.CommandText = "SELECT Id,TransactionDate,Transaction,TransactionNumber,TransactionAmount,TransactionType,TransactionDescription FROM Transactions";
            ...
            while (reader.Read())
            {
                ...
                dataGridView1.Rows [ dataGridView1.Rows.Count -1 ].Cells["TransactionNumber"].Value = reader[1].ToString() ;
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["TransactionDate"].Value = reader[2].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["TransactionType"].Value = reader[3].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["TransactionAmount"].Value = reader[4].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["TransactionDescription"].Value = reader[5].ToString();
        }
            connect.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand command = new OleDbCommand();
            command.Connection = connect;
            command.CommandText = "SELECT ID,TransactionDate,CurrentAccountBalance,CurrentCreditBalance,CurrentDebitBalance FROM Balances";
            ...
            {
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["ID"].Value = reader[0].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["TransactionDate"].Value = reader[1].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["CurrentAccountBalance"].Value = reader[2].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["CurrentCreditBalance"].Value = reader[3].ToString();
                dataGridView1.Rows[dataGridView1.Rows.Count - 1].Cells["CurrentDebitBalance"].Value = reader[4].ToString();
;
            }
            connect.Close();
        }
